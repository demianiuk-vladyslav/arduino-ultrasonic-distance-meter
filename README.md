...
Повна пояснювальна записка до курсового проєкту (структурні й функціональні схеми, обґрунтування вибору елементної бази, результати експериментальних досліджень, повний лістинг коду): [docs/project_report.pdf](docs/project_report.pdf)
...
![Зібраний пристрій](images/device_photo.png)
*Повністю зібраний прототип на макетній платі та перевірка напруги*

![Зелений режим сигналізації](images/led_indication_green.jpg)
*Відстань ≥ 50 см — активний зелений світлодіод*

![Червоний режим сигналізації](images/led_indication_red.png)
